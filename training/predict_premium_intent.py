...
def main() -> None:
    parser = argparse.ArgumentParser(description="Predict Momentum intent with the premium fine-tuned encoder.")
    parser.add_argument("text", nargs="+")
    parser.add_argument("--model-dir", default="models/momentum_intent/premium_latest")
