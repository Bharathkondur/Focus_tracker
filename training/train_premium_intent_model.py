...
def main() -> None:
    ...
    train_dataset = IntentTextDataset(train_rows, tokenizer, label_to_id, args.max_length)
    val_dataset = IntentTextDataset(val_rows, tokenizer, label_to_id, args.max_length)
    test_dataset = IntentTextDataset(test_rows, tokenizer, label_to_id, args.max_length)
    ...
    latest_dir = output_dir.parent / "premium_latest"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Fine-tune a pretrained local encoder for Momentum intent routing.")
    parser.add_argument("--dataset", default="training_data/final/momentum_intent_20k_balanced.jsonl")
    parser.add_argument("--output-dir", default="models/momentum_intent/premium_run")
    parser.add_argument("--base-model", default="microsoft/MiniLM-L12-H384-uncased")
...
def save_model(output_dir: Path, model, tokenizer) -> None:
